...
export class BarcodeScannerDrawer {
  ...
  draw = (
    ...
    prediction.forEach((info) => {
      ...
      outputCtx.lineTo(
        info.p2_x * this.outputCanvas!.width,
        info.p2_y * this.outputCanvas!.height
      );
      outputCtx.lineTo(
        info.p3_x * this.outputCanvas!.width,
        info.p3_y * this.outputCanvas!.height
      );
      outputCtx.lineTo(
        info.p4_x * this.outputCanvas!.width,
        info.p4_y * this.outputCanvas!.height
      );
      outputCtx.lineTo(
        info.p1_x * this.outputCanvas!.width,
        info.p1_y * this.outputCanvas!.height
