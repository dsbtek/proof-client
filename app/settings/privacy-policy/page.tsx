        ...
        <div className="container scroller">
            <div className="items-wrap">
                ...
                <div className="privacy-policy-content">
                    ...
                    <p className="privacy-text">The Health Insurance Portability and Accountability Act (HIPAA)</p>
                    <p className="privacy-text">RecoveryTrek LLC uses many security features to ensure that only authorized users access “protected health information (PHI).” The following measures are set forth for compliance of HIPAA regulations for Privacy and Security.</p>
                    <p className="privacy-text">The Privacy Rule protects all PHI, or “individually identifiable health information” held or transmitted by RecoveryTrek. Individually identifiable health information includes many common identifiers (e.g., name, address, birth date, Social Security Number, credit card data), as well as the provision of health care to an individual (physical or mental).</p>

                    <h4 className="set-text">How We Collect Information About You?</h4>
                    <p className="privacy-text">Only authorized RecoveryTrek employees may collect data (through a variety of means including but not necessarily limited to letters, phone calls, emails, voice mails, and from the submission of enrollment applications) that is either required by law, or necessary to serve participants and clients. The CEO is responsible for developing and implementing privacy compliance and is the person to receive complaints and provide additional information.</p>
                    ...
                    <p className="privacy-text">We do not give out, exchange, barter, rent, sell, lend, or disseminate any information about participants or clients who receive our services that is considered patient confidential, is restricted by law, or has been specifically restricted by a patient/client.</p>
                    ...
                    <p className="privacy-text">The Security Rule specifies our administrative, physical, and technical safeguards for the confidentiality, integrity, and availability of electronic protected health information (e-PHI).</p>
                    <p className="privacy-text">HIPAA Security Risk Assessment regulations concerning Network Security Standards are effective April 21, 2005. Compliance ensures that only those who should have access to e-PHI actually have access.</p>

                    <h4 className="set-text">ReecoveryTrek:</h4>
                    <div>
                        <p className="privacy-text">1. Ensures the confidentiality, integrity, and availability of all e-PHI we create, receive, maintain or transmit;</p>
                        <p className="privacy-text">2. Identifies and protects against reasonably anticipated threats to the security or integrity of the information;</p>
                        <p className="privacy-text">3. Protects against reasonably anticipated, impermissible uses or disclosures; and</p>
                        <p className="privacy-text">4. Ensures compliance by our workforce</p>
                    </div>
                    <p className="privacy-text">The Security Standards are divided into three Safeguard categories including Administrative, Physical, and Technical. Administrative Safeguards deal primarily with the personnel and planning functions necessary for a Covered HealthCare Provider to comply. The majority of the Physical and Technical Safeguards are a function of a system’s network infrastructure, hardware capability, and our Software Application. The following list of risk factors represent the primary Security Implementation Specifications:</p>

                    <h4 className="set-text">1. Does the RecoveryTrek system permit data encryption/decryption?</h4>
                    <p className="privacy-text">Yes, any wide area network which is Internet based is fully encrypted with local connection optionally encrypted.</p>

                    <h4 className="set-text">2. Does each user have a unique user identification code?</h4>
                    <p className="privacy-text">Yes.</p>

                    <h4 className="set-text">3. Does each user have a unique user password?</h4>
                    <p className="privacy-text">Yes. The system requires the user to enter his/her password at login. Furthermore, the system can require users to change their passwords a set number of days.</p>

                    <h4 className="set-text">4. Are there integrity controls for transmission?</h4>
                    <p className="privacy-text">Yes.</p>

                    <h4 className="set-text">5. Are users automatically logged off after a period of inactivity?</h4>
                    <p className="privacy-text">Yes, In compliance with the client’s security policy, this will be set up to log Users off after a pre-determined time of inactivity.</p>

                    <h4 className="set-text">6. Is the data protected from unauthorized, unanticipated or unintentional alteration, including detection of such activities?</h4>
                    <p className="privacy-text">Yes.</p>

                    <h4 className="set-text">7. Are there mechanisms to record and examine user activity?</h4>
                    <p className="privacy-text">Yes, RecoveryTrek tracks user activity in critical areas of software use. RecoveryTrek can also track a record of screens accessed without data change. This added functionality is available as an add-on module.</p>

                    <h4 className="set-text">8. Are there procedures for accessing the application during an emergency?</h4>
                    <p className="privacy-text">Yes.</p>

                    <h4 className="set-text">Server, Network, and Application level Security</h4>
                    <p className="privacy-text">The most basic type of security is physical security of the server and backup media. Access and times are restricted to only authorized users (role-based access). In addition, the server is accessed only from authorized locations, and the data is protected while it is in transit. Router configurations, access lists, and other similar tools are used to ensure that only users in authorized locations are able to gain access.</p>
                    <p className="privacy-text">We also encrypt data in transit between the user session and the server. In such cases, RecoveryTrek uses Secure Socket Layer (SSL) encryption, a standard Internet encryption, or Virtual Private Networking (VPN).</p>
                    ...
                    <p className="privacy-text">RecoveryTrek complies with all government regulations for data transmission and storage, including the HIPAA Electronic Transaction and Code Sets Rule. Our CEO is the Security Official responsible for developing and implementing security policies and procedures, to include annual assessment of how well these meet requirements of the Security Rule.</p>
                </div>
            </div>
        </div>
    )
