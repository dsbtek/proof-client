...
const IDCardScanResult = () => {
  ...
  return (
    <div className="id-detection-container_">
      <AgreementHeader title="PIP - ID Scan Result" hasMute={false} />
      <br />
      <br />
      <div className="vid-items-wrap">
        <div className="captured-ids" style={{ marginTop: "40px" }}>
          ...
          <Image
            className="captured-id"
            src={idFront}
            alt="proof captured Image"
            width={200}
            height={300}
            loading="lazy"
          />
        ...
        <div>
          <Button
            classname="prompt-yes-btn m-5 move-center"
            link={"/identity-profile/id-detection/step-1"}
          >
            Recapture
          </Button>
        </div>
