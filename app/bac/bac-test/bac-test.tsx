          ...
          {!capturedImage && (
            <div className="sub-item">
              ...
              {result ? (
                ...
                >
                  <li>
                    Your Blood Alcohol Concentration (BAC) result is now
                    available.
                  </li>
                  <li>Your BAC is 0.00255, which is Positive.</li>
                  <li>
                    Please review the result to understand your current alcohol
                    level and take any necessary actions.
                  </li>
                </ul>
              ) : (
                <p className="">
                  Please breathe into the device steadily until the indicator
                  below shows full power. This ensures accurate measurement and
                  optimal performance.
                </p>
              )}
              <BacProgressBar
